...
terraform init                                                                       \
               --backend-config "resource_group_name=GLOBAL-EUS2-SAP_LIBRARY"            \
               --backend-config "storage_account_name=globaeus2tfstate1c46"             \
               --backend-config "container_name=tfstate"                             \
               --backend-config "key=GLOBAL-EUS2-SAP_LIBRARY.terraform.tfstate"          \
...
egrep -wi 'resource_group_name|storage_account_name|container_name' ../../SAP_LIBRARY/GLOBAL-EUS2-SAP_LIBRARY/.terraform/terraform.tfstate
...
terraform init                                                                       \
               ...
               --backend-config "storage_account_name=globaeus2tfstate1c46"             \
               --backend-config "container_name=tfstate"                             \
               --backend-config "key=GLOBAL-EUS2-DEP00-INFRASTRUCTURE.terraform.tfstate" \
               ../../../sap-hana/deploy/terraform/run/sap_deployer/
...
terraform init                                                                       \
                ...
                --backend-config "storage_account_name=globaeus2tfstate1c46"            \
                --backend-config "container_name=tfstate"                            \
                --backend-config "key=GLOBAL-EUS2-SAP0-INFRASTRUCTURE.terraform.tfstate" \
...
#                 --backend-config "storage_account_name=globaeus2tfstate1c46"            \
#                 --backend-config "container_name=tfstate"                            \
#                 --backend-config "key=GLOBAL-EUS2-SAP0-X00.terraform.tfstate"            \
#                 ../../../sap-hana/deploy/terraform/run/sap_system/
...
mkdir -p ~/Azure_SAP_Automated_Deployment/WORKSPACES/SAP_SYSTEM/GLOBAL-EUS2-SAP0-X01; cd $_
cp ../../LOCAL/GLOBAL-EUS2-DEP00-INFRASTRUCTURE/sshkey* .


vi GLOBAL-EUS2-SAP0-X01.json
...
storage_account_name  = "globaeus2tfstate1c46"
container_name        = "tfstate"
key                   = "GLOBAL-EUS2-SAP0-X01.terraform.tfstate"
EOF
...
mkdir -p ~/Azure_SAP_Automated_Deployment/WORKSPACES/SAP_SYSTEM/GLOBAL-EUS2-SAP0-X02; cd $_
cp ../../LOCAL/GLOBAL-EUS2-DEP00-INFRASTRUCTURE/sshkey* .


vi GLOBAL-EUS2-SAP0-X02.json
...
storage_account_name  = "globaeus2tfstate1c46"
container_name        = "tfstate"
key                   = "GLOBAL-EUS2-SAP0-X02.terraform.tfstate"
EOF
